...
public class PaymentService (IGenericRepository<Payment> repository)
{
    ...
    public async Task AddAsync(Payment entity) => repository.AddAsync(entity);
    public async Task UpdateAsync(Payment entity) => repository.UpdateAsync(entity);
    public async Task DeleteAsync(Payment entity) => repository.DeleteAsync(entity);
}